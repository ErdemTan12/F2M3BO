...
public class homing : MonoBehaviour
{
    ...
    public float speed = 1f; //de snelheid van de raket
    ...
    {   //while loop lol
        ...
        {
            rocket.transform.position += (target.transform.position - rocket.transform.position).normalized * speed * Time.deltaTime; //als de distance langer is dan 0.3 dan begint de raket met bewegen
